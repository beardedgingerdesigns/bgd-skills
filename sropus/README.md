...
Origin: IndyDevDan's "Fixing Smartass Opus 5" — repo `github.com/disler/fixing-smartass-opus-5`, video `youtu.be/S_QdQ1G4GlU`.
...
## Two edits vs Dan's original

1. **Dropped** his "never add a co-author to a commit message" line — it contradicts the global `Co-Authored-By` rule. Global CLAUDE.md governs attribution.
2. Fixed typos.
